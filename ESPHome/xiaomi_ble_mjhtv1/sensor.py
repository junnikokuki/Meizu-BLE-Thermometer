...
xiaomi_ble_mjhtv1_ns = cg.esphome_ns.namespace('xiaomi_ble_mjhtv1')
XiaomiBLEMJHTV1 = xiaomi_ble_mjhtv1_ns.class_('XiaomiBLEMJHTV1', esp32_ble_client.ESPBTClientListener, cg.Component)

CONFIG_SCHEMA = cv.Schema({
    cv.GenerateID(): cv.declare_id(XiaomiBLEMJHTV1),
